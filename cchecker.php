                                    ...
                                    <div class="col-md-8 offset-md-2">
                                        <div class="contact_form--wrapper">
                                            <form method="post">
                                                ...
                                                <textarea cols="30" rows="10" type="text" class="form-control" method="POST" name="icerik" placeholder="Düzenlenmiş Datanızı '4400667905592642|08|2024|249
' Bu Şekilde Yerleştiriniz. *"></textarea>
...
<b><h5>Kalan ücretsiz kullanıcı check limiti </h5></b>
<div class="progress">
